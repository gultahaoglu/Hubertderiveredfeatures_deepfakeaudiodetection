...
OUT_FOLD   = r".\models\HUBERT_XLARGE_L8_ecapa_tdnn"
FEAT_LEN   = 750
PADDING    = "repeat"
BATCH_SIZE = 32
NUM_WORKERS = 0
...
def evaluate(model: torch.nn.Module,
    ...
    eval_ds = WavLMFeatureDataset(
        ACCESS_TYPE, PATH_TO_FEATURES, PATH_TO_PROTOCOL_DIR,
    ...
    try:
        ...
        print("[Eval] tDCF hesabı yapılamadı →", e)
        # Yine de EER'i kendimiz çıkartabiliriz:
